var systemComponents = {
	...
	'info-tab': {
		...
		<br>
        已游玩时长：{{ formatTime(player.timePlayed) }}<br>
		<br>
        模组树模板版本：<a v-bind:href="'https://github.com/Acamaeda/The-Modding-Tree/blob/master/changelog.md'" target="_blank" class="link" v-bind:style = "{'font-size': '14px', 'display': 'inline'}" >{{TMT_VERSION.tmtNum}}</a>
		<br>模组树模板作者：Acamaeda
        <br>最初的声望树作者：Jacorb, Aarex
		<br>本模组树作者：{{modInfo.author}}
		<br>
		<br>
