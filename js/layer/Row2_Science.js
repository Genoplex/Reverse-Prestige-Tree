addLayer('Science', {
    ...
    symbol: () => getI18N('Science.Title'),
    tooltip() { return 'test' },
    tooltipLocked: () => getI18N('Science.Tooltip.Lock', {
    ...
    requires() {
        return new Decimal(10000000000).mul((player.Science.unlockOrder && !player.Science.unlocked) ? 1e100 : 1)
    },
    exponent: 0.2,
    resource: () => getI18N('Common.Resources.Science.points'),
    ...
    tabFormat: {
        'Empire': {
            TabName: () => getI18N('Science.LayerName.Science'),
            content() {
                let tabformat = []
                tabformat.push(['display-text', getI18N('Science.TabFormat.Science.Resource', {
                    Amount: format(player.Empire.points),
                    Name: getI18N('Common.Resources.Science.points')
                })])
